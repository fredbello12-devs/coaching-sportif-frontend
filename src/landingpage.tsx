      ...
      <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-7">
          ...
          <p className="font-body text-lg text-white/50 leading-relaxed max-w-md">
            Des coachs certifiés, des programmes sur-mesure et un suivi en
            temps réel pour atteindre tes objectifs — sans excuses.
          </p>
        ...
        <div className="flex justify-center lg:justify-end">
          ...
          >
            ...
            <div className="absolute -right-4 bottom-1/4 bg-[#1A1A1A] border border-yellow-500/30 rounded-xl px-4 py-3 shadow-xl hidden lg:block">
              <div className="font-display text-xl text-yellow-400">⚡ +8%</div>
              <div className="font-body text-xs text-white/40">
                Cette semaine
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {coachs.map((coach) => (
            ...
            >
              {coach.featured && (
                <div
                  className="absolute -top-3 left-1/2 -translate-x-1/2 text-black text-xs font-heading font-bold tracking-widest uppercase px-4 py-1 rounded-full"
                  style={{
                    background: "linear-gradient(135deg,#FF4D00,#FFB800)",
                  }}
                >
              ...
              <div className="relative w-24 h-24 mx-auto mb-5">
                <div
                  ...
                  style={{ backgroundColor: `${coach.color}15` }}
                >
                  {coach.emoji}
                </div>
                <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-green-400 border-2 border-[#111]" />
              </div>
              ...
              <div className="text-center mb-4">
                ...
                <p className="font-body text-xs text-white/30">{coach.exp}</p>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-4">
                {coach.specialites.map((s) => (
                  <span
                    key={s}
                    className="text-xs font-heading tracking-wide px-3 py-1 rounded-full"
                    style={{
              ...
              {/* Stats */}
              <div className="flex justify-center gap-6 border-t border-white/5 pt-4 mb-4">
                <div className="text-center">
                  ...
                  <span className="font-body text-xs text-white/30">Note</span>
                </div>
                <div className="text-center">
              ...
              {/* CTA */}
              <button
                className="w-full font-heading text-sm tracking-widest uppercase py-3 rounded-xl transition-all duration-300 font-bold"
                style={
                  coach.featured
                    ? {
                        background:
